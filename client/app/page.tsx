        ...
        <div className="fixed inset-0 z-[100] lg:hidden">
          ...
          >
            ...
            <div className="mt-auto space-y-6">
              ...
              className="w-full py-5 bg-white text-coffee-600 border-2 border-coffee-600 rounded-2xl font-bold text-lg shadow-sm active:scale-95 transition-all dark:bg-white dark:text-coffee-900"
            >
              Book a Table
            </button>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-2xl mx-auto md:mx-0">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => setIsBookingOpen(true)} className="px-8 py-4 bg-white border-2 border-coffee-600 text-coffee-600 rounded-full font-bold hover:bg-gray-50 transition-all shadow-lg shadow-coffee-600/10 dark:bg-white dark:text-coffee-900">Book a Table</motion.button>
            </div>
          </motion.div>
        </div>
      </section>
